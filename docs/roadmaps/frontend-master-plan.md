...
- 📋 **Remaining** — Schedule Foundation (weekly calendar/daily timeline/availability blocks), Patient Queue architecture, Consultation Workspace layout, further reusable components (`PatientQueueCard`, `ScheduleCard`, `EmptyWorkspace`, `ConsultationContainer`) — subsequent milestones
