...
- 📋 **Remaining** — Patient Queue architecture, Consultation Workspace layout, further reusable components (`PatientQueueCard`, `EmptyWorkspace`, `ConsultationContainer`) — subsequent milestones
