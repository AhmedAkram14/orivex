...
**Priority:** P0 · **Status:** 📋 Planned · **Depends on:** Phase 0 · **Backend dependency:** none
...
**Definition of done:** a documented (Storybook or equivalent) set of primitives covering every state (default/loading/empty/error/success), both directions (LTR/RTL), and both themes (light/dark) for the components the next several phases will need.
