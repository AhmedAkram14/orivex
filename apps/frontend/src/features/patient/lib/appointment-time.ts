...
// Join-Window Enforcement now applies symmetrically to both roles, so the
// window constants and canJoinCall live in shared/lib/consultation --
// re-exported here so existing patient-feature imports don't need to change.
export { canJoinCall, JOIN_WINDOW_OPENS_BEFORE_MS, JOIN_WINDOW_CLOSES_AFTER_MS } from '@/shared/lib/consultation/join-window';
