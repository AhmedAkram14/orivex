...
export const NAVIGATION_CONFIG: NavItemConfig[] = [
  ...
  // nav-reachable.
  {
    ...
    children: [
      ...
      {
        id: 'doctor-workspace-messages',
        labelKey: 'doctorMessages',
        icon: MessageCircle,
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'admin-workspace-audit-log',
        labelKey: 'adminAuditLog',
        icon: ScrollText,
        href: '/admin/audit-log',
        roles: ['super_admin'],
      },
      {
        id: 'admin-workspace-reviews',
        labelKey: 'adminReviews',
        icon: Flag,
        href: '/admin/reviews',
        roles: ['super_admin'],
      },
      {
        id: 'admin-workspace-disputes',
