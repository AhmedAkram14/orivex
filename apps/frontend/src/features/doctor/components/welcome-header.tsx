...
/** The Doctor Workspace's greeting banner — avatar, name, and today's date. Reads the session directly (`useAuth`) rather than accepting a `user` prop, since it only ever renders inside the authenticated Doctor Workspace. */
