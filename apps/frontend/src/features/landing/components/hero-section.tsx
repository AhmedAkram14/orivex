...
export function HeroSection() {
  ...
  return (
    <Container size="lg" className="flex flex-col items-center gap-6 py-20 text-center sm:py-28">
      <Logo size="xl" />
      <Display className="max-w-3xl text-balance">{t('headline')}</Display>
      <Text size="lg" tone="secondary" className="max-w-2xl text-balance">
        {t('subheadline')}
      </Text>
