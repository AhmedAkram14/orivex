...
export const DEMO_DOCTORS: DemoDoctor[] = [
  ...
  { accountId: 'user-doctor-16', email: 'doctor16@orivex.dev', displayName: 'Dr. Aya Mostafa', gender: 'female', avatarUrl: '/demo/avatars/doctor-16.png', specialtyName: 'Internal Medicine', professionalRank: 'specialist', yearsOfExperience: 10, biography: 'Specialist in internal medicine with a focus on diabetes and chronic disease management.', languages: ['Arabic', 'English'], insuranceProviders: ['AXA Egypt'], consultationFeeAmount: 300, hospitalName: 'Nile Medical Center', verification: 'approved' },
  { accountId: 'user-doctor-17', email: 'doctor17@orivex.dev', displayName: 'Dr. Mostafa Ragab', gender: 'male', avatarUrl: '/demo/avatars/doctor-17.png', specialtyName: 'Orthopedics', professionalRank: 'consultant', yearsOfExperience: 18, biography: 'Consultant orthopedic surgeon specializing in sports injuries and joint reconstruction.', languages: ['Arabic', 'English'], insuranceProviders: ['Misr Insurance', 'MetLife Egypt'], consultationFeeAmount: 550, hospitalName: 'Cairo International Hospital', verification: 'approved' },
...
export const DEMO_PATIENTS: DemoPatient[] = [
  ...
  { accountId: 'user-patient-2', email: 'patient02@orivex.dev', displayName: 'Omar Mahmoud', gender: 'male', avatarUrl: '/demo/avatars/patient-02.png', dateOfBirthYearsAgo: 28, bloodType: 'A+', hasInsurance: true, emergencyContactName: 'Mahmoud Saeed', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201002234567', verification: 'approved' },
  ...
  { accountId: 'user-patient-7', email: 'patient07@orivex.dev', displayName: 'Nour Sami', gender: 'female', avatarUrl: '/demo/avatars/patient-07.png', dateOfBirthYearsAgo: 22, hasInsurance: false, emergencyContactName: 'Sami Adel', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201007234567', verification: 'approved' },
  { accountId: 'user-patient-8', email: 'patient08@orivex.dev', displayName: 'Hassan Tawfik', gender: 'male', avatarUrl: '/demo/avatars/patient-08.png', dateOfBirthYearsAgo: 55, bloodType: 'O-', chronicDiseases: 'Hypertension', hasInsurance: true, emergencyContactName: 'Tawfik Hassan Jr.', emergencyContactRelationship: 'child', emergencyContactPhone: '+201008234567', verification: 'approved' },
  { accountId: 'user-patient-9', email: 'patient09@orivex.dev', displayName: 'Mona Farouk', gender: 'female', avatarUrl: '/demo/avatars/patient-09.png', dateOfBirthYearsAgo: 38, bloodType: 'A-', hasInsurance: true, emergencyContactName: 'Farouk Samy', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201009234567', verification: 'approved' },
  { accountId: 'user-patient-10', email: 'patient10@orivex.dev', displayName: 'Karim Mostafa', gender: 'male', avatarUrl: '/demo/avatars/patient-10.png', dateOfBirthYearsAgo: 29, hasInsurance: false, emergencyContactName: 'Mostafa Karim Sr.', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201010234567', verification: 'approved' },
  { accountId: 'user-patient-11', email: 'patient11@orivex.dev', displayName: 'Sara Zaki', gender: 'female', avatarUrl: '/demo/avatars/patient-11.png', dateOfBirthYearsAgo: 33, allergies: 'Shellfish, pollen', hasInsurance: true, emergencyContactName: 'Zaki Mounir', emergencyContactRelationship: 'sibling', emergencyContactPhone: '+201011234567', verification: 'approved' },
  ...
  { accountId: 'user-patient-13', email: 'patient13@orivex.dev', displayName: 'Amina Youssef', gender: 'female', avatarUrl: '/demo/avatars/patient-13.png', dateOfBirthYearsAgo: 30, bloodType: 'B-', hasInsurance: true, emergencyContactName: 'Youssef Kamal', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201013234567', verification: 'approved' },
