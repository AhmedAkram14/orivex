...
export const DEMO_DOCTORS: DemoDoctor[] = [
  ...
  { accountId: 'user-doctor-20', email: 'doctor20@orivex.dev', displayName: 'Dr. Hossam Fathy', gender: 'male', avatarUrl: '/demo/avatars/doctor-20.png', specialtyName: 'Ophthalmology', professionalRank: 'registrar', yearsOfExperience: 5, biography: 'Ophthalmologist providing routine eye exams and treatment for common vision conditions, offered free of charge while completing his registrar training.', languages: ['Arabic', 'English'], insuranceProviders: [], consultationFeeAmount: undefined, hospitalName: undefined, verification: 'approved' },
];
...
/**
 * Data Density & Full Coverage pass: mirrors the backend's own reversal --
 * every demo patient must show real activity now, so this stays an empty
 * Set (kept, not deleted, since demo-seeder.ts still reads it).
 */
