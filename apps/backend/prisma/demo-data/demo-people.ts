...
export const DEMO_PATIENTS: DemoPatient[] = [
  { email: 'patient01@orivex.dev', displayName: 'Ahmed Ali', gender: 'male', avatarUrl: '/demo/avatars/patient-01.png', dateOfBirthYearsAgo: 34, bloodType: 'O+', hasInsurance: true, emergencyContactName: 'Fatma Ali', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201001234567', verification: 'approved' },
  { email: 'patient02@orivex.dev', displayName: 'Omar Mahmoud', gender: 'male', avatarUrl: '/demo/avatars/patient-02.png', dateOfBirthYearsAgo: 28, bloodType: 'A+', hasInsurance: true, emergencyContactName: 'Mahmoud Saeed', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201002234567', verification: 'approved' },
  ...
  { email: 'patient04@orivex.dev', displayName: 'Mariam Ahmed', gender: 'female', avatarUrl: '/demo/avatars/patient-04.png', dateOfBirthYearsAgo: 25, hasInsurance: false, emergencyContactName: 'Ahmed Farouk', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201004234567', verification: 'approved' },
  { email: 'patient05@orivex.dev', displayName: 'Salma Khaled', gender: 'female', avatarUrl: '/demo/avatars/patient-05.png', dateOfBirthYearsAgo: 31, bloodType: 'AB+', hasInsurance: true, emergencyContactName: 'Khaled Reda', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201005234567', verification: 'approved' },
  ...
  { email: 'patient07@orivex.dev', displayName: 'Nour Sami', gender: 'female', avatarUrl: '/demo/avatars/patient-07.png', dateOfBirthYearsAgo: 22, hasInsurance: false, emergencyContactName: 'Sami Adel', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201007234567', verification: 'approved' },
  { email: 'patient08@orivex.dev', displayName: 'Hassan Tawfik', gender: 'male', avatarUrl: '/demo/avatars/patient-08.png', dateOfBirthYearsAgo: 55, bloodType: 'O-', chronicDiseases: 'Hypertension', hasInsurance: true, emergencyContactName: 'Tawfik Hassan Jr.', emergencyContactRelationship: 'child', emergencyContactPhone: '+201008234567', verification: 'approved' },
  { email: 'patient09@orivex.dev', displayName: 'Mona Farouk', gender: 'female', avatarUrl: '/demo/avatars/patient-09.png', dateOfBirthYearsAgo: 38, bloodType: 'A-', hasInsurance: true, emergencyContactName: 'Farouk Samy', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201009234567', verification: 'approved' },
  { email: 'patient10@orivex.dev', displayName: 'Karim Mostafa', gender: 'male', avatarUrl: '/demo/avatars/patient-10.png', dateOfBirthYearsAgo: 29, hasInsurance: false, emergencyContactName: 'Mostafa Karim Sr.', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201010234567', verification: 'approved' },
  { email: 'patient11@orivex.dev', displayName: 'Sara Zaki', gender: 'female', avatarUrl: '/demo/avatars/patient-11.png', dateOfBirthYearsAgo: 33, allergies: 'Shellfish, pollen', hasInsurance: true, emergencyContactName: 'Zaki Mounir', emergencyContactRelationship: 'sibling', emergencyContactPhone: '+201011234567', verification: 'approved' },
  { email: 'patient12@orivex.dev', displayName: 'Dina Adel', gender: 'female', avatarUrl: '/demo/avatars/patient-12.png', dateOfBirthYearsAgo: 26, hasInsurance: true, emergencyContactName: 'Adel Fathallah', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201012234567', verification: 'pending' },
  { email: 'patient13@orivex.dev', displayName: 'Amina Youssef', gender: 'female', avatarUrl: '/demo/avatars/patient-13.png', dateOfBirthYearsAgo: 30, bloodType: 'B-', hasInsurance: true, emergencyContactName: 'Youssef Kamal', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201013234567', verification: 'approved' },
  { email: 'patient14@orivex.dev', displayName: 'Rana Sobhy', gender: 'female', avatarUrl: '/demo/avatars/patient-14.png', dateOfBirthYearsAgo: 24, hasInsurance: false, emergencyContactName: 'Sobhy Ahmed', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201014234567', verification: 'pending' },
  { email: 'patient15@orivex.dev', displayName: 'Tarek Aziz', gender: 'male', avatarUrl: '/demo/avatars/patient-15.png', dateOfBirthYearsAgo: 44, bloodType: 'O+', chronicDiseases: 'Asthma', hasInsurance: true, emergencyContactName: 'Aziz Younis', emergencyContactRelationship: 'sibling', emergencyContactPhone: '+201015234567', verification: 'approved' },
  { email: 'patient16@orivex.dev', displayName: 'Nadia Fawzy', gender: 'female', avatarUrl: '/demo/avatars/patient-16.png', dateOfBirthYearsAgo: 36, hasInsurance: true, emergencyContactName: 'Fawzy Ramzy', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201016234567', verification: 'approved' },
  { email: 'patient17@orivex.dev', displayName: 'Fady Nassar', gender: 'male', avatarUrl: '/demo/avatars/patient-17.png', dateOfBirthYearsAgo: 27, hasInsurance: false, emergencyContactName: 'Nassar Iskandar', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201017234567', verification: 'suspended' },
  { email: 'patient18@orivex.dev', displayName: 'Ghada Selim', gender: 'female', avatarUrl: '/demo/avatars/patient-18.png', dateOfBirthYearsAgo: 39, bloodType: 'AB-', hasInsurance: true, emergencyContactName: 'Selim Ashraf', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201018234567', verification: 'approved' },
  // Deliberately new/minimal patients — never booked an appointment yet, a
  // genuine, common real state, not something to paper over.
  { email: 'patient19@orivex.dev', displayName: 'Bassem Naguib', gender: 'male', avatarUrl: '/demo/avatars/patient-19.png', dateOfBirthYearsAgo: 23, hasInsurance: false, emergencyContactName: 'Naguib Boulos', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201019234567', verification: 'approved' },
  { email: 'patient20@orivex.dev', displayName: 'Iman Rashad', gender: 'female', avatarUrl: '/demo/avatars/patient-20.png', dateOfBirthYearsAgo: 21, hasInsurance: false, emergencyContactName: 'Rashad Hany', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201020234567', verification: 'approved' },
];
