...
export const DEMO_PATIENTS: DemoPatient[] = [
  ...
  { email: 'patient02@orivex.dev', displayName: 'Omar Mahmoud', gender: 'male', avatarUrl: '/demo/avatars/patient-05.png', dateOfBirthYearsAgo: 28, bloodType: 'A+', hasInsurance: true, emergencyContactName: 'Mahmoud Saeed', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201002234567', verification: 'approved' },
  ...
  { email: 'patient05@orivex.dev', displayName: 'Salma Khaled', gender: 'female', avatarUrl: '/demo/avatars/patient-02.png', dateOfBirthYearsAgo: 31, bloodType: 'AB+', hasInsurance: true, emergencyContactName: 'Khaled Reda', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201005234567', verification: 'approved' },
  ...
  { email: 'patient07@orivex.dev', displayName: 'Nour Sami', gender: 'female', avatarUrl: '/demo/avatars/patient-08.png', dateOfBirthYearsAgo: 22, hasInsurance: false, emergencyContactName: 'Sami Adel', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201007234567', verification: 'approved' },
  { email: 'patient08@orivex.dev', displayName: 'Hassan Tawfik', gender: 'male', avatarUrl: '/demo/avatars/patient-07.png', dateOfBirthYearsAgo: 55, bloodType: 'O-', chronicDiseases: 'Hypertension', hasInsurance: true, emergencyContactName: 'Tawfik Hassan Jr.', emergencyContactRelationship: 'child', emergencyContactPhone: '+201008234567', verification: 'approved' },
  { email: 'patient09@orivex.dev', displayName: 'Mona Farouk', gender: 'female', avatarUrl: '/demo/avatars/patient-10.png', dateOfBirthYearsAgo: 38, bloodType: 'A-', hasInsurance: true, emergencyContactName: 'Farouk Samy', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201009234567', verification: 'approved' },
  { email: 'patient10@orivex.dev', displayName: 'Karim Mostafa', gender: 'male', avatarUrl: '/demo/avatars/patient-09.png', dateOfBirthYearsAgo: 29, hasInsurance: false, emergencyContactName: 'Mostafa Karim Sr.', emergencyContactRelationship: 'parent', emergencyContactPhone: '+201010234567', verification: 'approved' },
  { email: 'patient11@orivex.dev', displayName: 'Amir Zaki', gender: 'male', avatarUrl: '/demo/avatars/patient-11.png', dateOfBirthYearsAgo: 33, allergies: 'Shellfish, pollen', hasInsurance: true, emergencyContactName: 'Zaki Mounir', emergencyContactRelationship: 'sibling', emergencyContactPhone: '+201011234567', verification: 'approved' },
  ...
  { email: 'patient13@orivex.dev', displayName: 'Ziad Youssef', gender: 'male', avatarUrl: '/demo/avatars/patient-13.png', dateOfBirthYearsAgo: 30, bloodType: 'B-', hasInsurance: true, emergencyContactName: 'Youssef Kamal', emergencyContactRelationship: 'spouse', emergencyContactPhone: '+201013234567', verification: 'approved' },
