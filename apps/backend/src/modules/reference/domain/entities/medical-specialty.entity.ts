...
export class MedicalSpecialty {
  ...
  static create(props: { name: string }): MedicalSpecialty {
    const now = new Date();
    return new MedicalSpecialty(randomUUID(), props.name, true, now, now);
  }
  ...
  static reconstitute(props: {
    ...
    return new MedicalSpecialty(props.id, props.name, props.isActive, props.createdAt, props.updatedAt);
  }
