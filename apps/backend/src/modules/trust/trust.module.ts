...
// VerificationDocument, not a cross-module query.
@Module({
  imports: [DoctorModule, PatientModule, AuthenticationGuardsModule, TrustGuardsModule],
  controllers: [DoctorVerificationController, PatientVerificationController, VerificationCaseController],
  providers: [
